...
docker compose --profile compute up -d gateway map-postprocessor
docker compose ps gateway map-postprocessor

echo "Pi-local mapping gateway and Ubuntu map post-processor are ready."
